    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-brand-600 via-brand-700 to-purple-900">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-lg text-white/70 max-w-md">
            Join thousands of teams using AI-powered notes to collaborate, organize, and discover insights.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-gray-500 mb-8">Get started with AI-powered notes</p>
